...
### Fixed
- Added missing `navigation-widgets` to HTML5 theme support (required by WordPress.org accessibility-ready)
...
### Changed
- **Screenshot** - Updated to comply with WordPress.org requirements
